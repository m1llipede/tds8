/**********************************************************************
  TDS-8 (Track Display Strip - 8 channels)  — v33 OFFSET SUPPORT
...
// =======================  Firmware  =======================
#define FW_VERSION "0.33"   // ← bump this when you publish a new firmware
#define FW_BUILD "2025.10.17-handshake"  // ← build identifier (date + feature)
...
void drawTrackName(uint8_t screen, const String& name) {
  ...
  // Heartbeat indicator on OLED 8 (screen 7) - lower right corner
  if (screen == 7 && millis() <= heartbeatFlashUntil) {
