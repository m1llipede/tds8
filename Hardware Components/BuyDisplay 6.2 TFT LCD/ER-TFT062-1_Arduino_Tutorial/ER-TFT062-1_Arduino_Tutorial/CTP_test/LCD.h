...
#define Arduino_SPI     1 //1:use SPI to drive
  ...
  #define layer2_start_addr 921600    // 480*960*2
  #define layer3_start_addr 1843200   
  #define layer4_start_addr 2764800
  #define layer5_start_addr 3686400
  #define layer6_start_addr 4608000  
  #define layer7_start_addr 5529600 
  #define layer8_start_addr 6451200
  #define layer9_start_addr 7372800
  #define layer10_start_addr 8294400 
  #define layer11_start_addr 9216000
  


#define xoffset	     60
#define LCD_XSIZE_TFT    480   //NC60+360dots+NC60   Left offset:60   Right offset 60
