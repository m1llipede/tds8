...
// =======================  Firmware  =======================
#define FW_VERSION "0.31"   // ← bump this when you publish a new firmware
#define FW_BUILD "2025.10.13-offset"  // ← build identifier (date + feature)
...
void handleSerialLine(const String& line) {
  ...
  Serial.println("   /trackname <idx> <name> [actualTrack] - Set track name (0-7)");
