...
// =======================  Firmware  =======================
#define FW_VERSION "0.367"   // ← bump this when you publish a new firmware
#define FW_BUILD "2025.11.10-tolerant-parser"  // ← build identifier (date + feature)
