/**********************************************************************
  TDS-8 (Track Display Strip - 8 channels)  — v34 OFFSET SUPPORT
...
// =======================  Firmware  =======================
#define FW_VERSION "0.34"   // ← bump this when you publish a new firmware
#define FW_BUILD "2025.10.17-wired-indicators"  // ← build identifier (date + feature)
